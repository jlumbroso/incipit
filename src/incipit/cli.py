...
def main(audit, count, pages, systems, height_threshold, width_threshold, output, verbose, input):
    ...
    if count and output is None and systems is None:
        ...
        for i in range(offset2, 252):
          ...
          if( len(systems) - systemNumberInPDFList2[i-offset2] != 0 ):
            print(str(len(systems)) + "\t" + str(len(systems) - systemNumberInPDFList2[i-offset2]) + "\t" + input )
          else:
            print("matched " + str(i) + ".pdf")
          totalError += abs(len(systems) - systemNumberInPDFList2[i-offset2])
        for i in range(offset1, 559):
          ...
          if( len(systems) - systemNumberInPDFList1[i-offset1] != 0 ):
            print(str(len(systems)) + "\t" + str(len(systems) - systemNumberInPDFList1[i-offset1]) + "\t" + input )
          else:
            print("matched " + str(i) + ".pdf")
          totalError += abs(len(systems) - systemNumberInPDFList1[i-offset1])
